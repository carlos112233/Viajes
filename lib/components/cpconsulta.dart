...
class CpConsulta {
  CpConsulta({
    required this.claveBitacora,
    required this.consecOs,
    required this.folioBitacora,
    required this.terminalBitacora,
    required this.fechaBitacora,
    required this.tractoClave,
    required this.tractoNumEco,
    this.dollyNe,
    required this.remNe1,
    this.remNe2,
    required this.operadorClave,
    required this.prefijo,
    required this.statusBitacora,
    required this.terminalCierre,
    required this.terminalCarta,
    required this.folioCarta,
    required this.clienteNombre,
    required this.rutaDescripcion,
    required this.terminalClave,
    required this.ordenserFolio,
    required this.tipoUnidad,
    required this.tipoUnidadDescrip,
    required this.operadorNombre,
    required this.cartaporte,
    required this.rutaClave,
    required this.tractoPlacas,
    required this.fechaEntrega,
    required this.fechaCarga,
    required this.destinatarioNom,
    required this.rutaServicio,
    required this.origenNom,
    required this.clienteNombreCorto,
  });
